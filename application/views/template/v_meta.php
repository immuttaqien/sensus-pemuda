...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url('static/vendor/datatables-plugins/dataTables.bootstrap.css') ?>" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo base_url('static/vendor/datatables-responsive/dataTables.responsive.css') ?>" rel="stylesheet">
